...
pasta_metrics = 'teste-metrics'
pasta_stage_metrics = f'./{pasta_metrics}/stagemetrics'
pasta_aggregated_metrics = f'./{pasta_metrics}/stagemetrics_agg'

# buscar o json de cada uma eu nao sei o nome do json, estara como part-00000-algumacoisa.json
stage_metrics_file = f'{pasta_stage_metrics}/part-00000-*.json'
import glob
stage_metrics_files = glob.glob(stage_metrics_file)
aggregated_metrics_file = f'{pasta_aggregated_metrics}/part-00000-*.json'
aggregated_metrics_files = glob.glob(aggregated_metrics_file)
if not stage_metrics_files or not aggregated_metrics_files:
    raise FileNotFoundError("Stage metrics or aggregated metrics files not found.")
stage_metrics_file = stage_metrics_files[0]
aggregated_metrics_file = aggregated_metrics_files[0]
