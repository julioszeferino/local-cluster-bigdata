...
docker exec dsa-spark-master spark-submit --deploy-mode client \
    ./apps/aulas_spark_mastering/ch02_leitura_small_file_json.py
...
- Tamanho dos arquivos lidos total = 6.4MB [JSON]
====================================================================
"""
import os
...
def main():
    ...
    spark = sessao_spark('ch02-leitura-json')
    ...
    minio_bucket = "production/landing/mongodb/rides/json/*.json"
